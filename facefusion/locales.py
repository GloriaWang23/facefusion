...
LOCALES : Locales =\
{
	'en':
	{
		...
		'help':
		{
			...
			'face_swap_pairs': 'specify face swap pairs as json for map mode (e.g. [{"reference_face_position": 0, "source_paths": ["/path/img.jpg"]}])',
		...
		'uis':
		{
			...
			'face_map_pair_position_number': 'FACE POSITION',
			'face_map_pair_source_file': 'SOURCE IMAGE',
